...
{
	/// <summary>
	/// Scene-based <see cref="IEventPayloadHandler{TPeerType, TPayloadType}"/>
	/// </summary>
	...
	public abstract class EventPayloadHandlerComponent<TPeerType, TPayloadType> : MonoBehaviour, IEventPayloadHandler<TPeerType, TPayloadType>, IClassLogger
