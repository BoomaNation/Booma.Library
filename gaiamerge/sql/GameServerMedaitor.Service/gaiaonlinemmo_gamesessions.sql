...
CREATE TABLE `gamesessions` (
  ...
  `SessionCreationTime` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `SessionGuid` char(36) NOT NULL,
  `SessionIp` longtext NOT NULL,
  PRIMARY KEY (`UserId`),
  CONSTRAINT `FK_GameSessions_AvatarEntries_UserId` FOREIGN KEY (`UserId`) REFERENCES `avatarentries` (`UserId`) ON DELETE CASCADE
...
-- Dump completed on 2017-08-28 18:21:54
